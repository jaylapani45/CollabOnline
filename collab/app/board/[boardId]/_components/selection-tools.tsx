...
export const SelectionTools = memo(({camera,setLastUsedColor}:SelectionToolsProps) => {
    ...
    return(
        <div className="absolute p-3 rounded-xl bg-white shadow-sm border flex select-none" style={{transform: `translate(${x}px,${y-60}px)`}}>
         ...
         <div className="flex items-center pl-2 ml-2 border-l border-neutral-200">
            <Hint label="Delete">
                <Button onClick={deleteLayer} variant="board" size="icon"><Trash2 /></Button>
            </Hint>
         </div>
        </div>
    )
